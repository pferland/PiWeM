...
pprint("bmp180 Pressure")
pprint(mon.sensor_values.bmp180.pressure)
pprint("bmp180 Altitude")
pprint(mon.sensor_values.bmp180.altitude)
pprint("bmp180 Temp C")
pprint(mon.sensor_values.bmp180.temperature)
pprint("bmp280 Temp F")
pprint((mon.sensor_values.bmp180.temperature * (9/5)) + 32)
pprint("bmp180 raw_temp")
pprint(mon.sensor_values.bmp180.raw_temp)
pprint("bmp180 raw_pressure")
pprint(mon.sensor_values.bmp180.raw_pressure)
pprint("bmp180 sealevel_pressure")
pprint(mon.sensor_values.bmp180.sealevel_pressure)
pprint("-------")
pprint("dht11 Temp C")
pprint(mon.sensor_values.dht11.temp[0] if mon.sensor_values.dht11.temp else 0.0)
pprint("dht11 Temp F")
pprint(mon.sensor_values.dht11.temp[1] if mon.sensor_values.dht11.temp else 0.0)
pprint("dht11 humidity")
