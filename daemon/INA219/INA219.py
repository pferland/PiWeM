...
# ===========================================================================
	...
	def getCurrent_mA(self):
		...
		#print "Current Raw: " + str(self.getCurrent_raw())
		valueDec /= self.ina219_currentDivider_mA
		#print "Current Divider mW: " + str(self.ina219_currentDivider_mA)
		return valueDec
		
	def getPower_mW(self):
		valueDec = float(self.getBusVoltage_V()) * float(self.getCurrent_mA())
		#print "Power Raw: " + str(self.getPower_raw())
		#valueDec /= self.ina219_powerDivider_mW
		#print "Power Divider mW: " + str(self.ina219_powerDivider_mW)
		#print str(type(valueDec)) + " : " + str(valueDec)
		return valueDec
